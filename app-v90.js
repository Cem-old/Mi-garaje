...
function editWorkshop(id,defaultKind='Mantenimiento'){
  ...
  let km=promptNumber('Kilómetros del vehículo en esta intervención',x?.km??V()?.km??'');if(km===null||km===undefined)return;
